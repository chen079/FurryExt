    ...
    return {
        ...
        editable: false, content: function (config, pack) {
			...
			if(config.furry_onlineUpdate2){
                fetch('https://charlin079.coding.net/p/furryext/d/FurryExt/git/tree/master/updatecheck.js',{
                    method: 'GET',
                    mode:'cors',// 允许发送跨域请求
                    credentials: 'include',
                    headers: {
            ...
            "furry_onlineUpdate": {
                ...
                onclick: function () {
                    ...
                    const address = 'https://charlin079.coding.net/p/furryext/d/FurryExt/git/tree/master/';
                    if (button.disabled) {
                        return;
                    } else {
